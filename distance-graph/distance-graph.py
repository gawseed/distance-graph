...
def parse_args():
    parser = ArgumentParser(formatter_class=ArgumentDefaultsHelpFormatter,
                            description=__doc__,
                            epilog='Example Usage: python distance-graph.py -n command -l source --templatize -e 0.945 -E myedgelist.fsdb -c myclusterlist.fsdb -w 12.5 -H 8.5 -fs 8 -ns 250 "/nfs/lander/working/erinszet/data/gawseed/fsdb/2020-01_cowrie_haas_origcmds.fsdb" test.png')
...
def draw_networkx(args,weightDic,cmdIPsDic,sourceDic,cmdToArray):
    ...
    return G,weighted_edges,labels
